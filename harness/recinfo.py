...
and, from version 5, a bob switch instead, which name one of smoothstep, linear and bob, or
...
walk bob's amount, three multipliers and hops, which are the bob movement's settings when
